...
vim.keymap.set({ 'n', 'v' }, 'H', "_", { silent = true })
vim.keymap.set({ 'n', 'v' }, 'L', "g_", { silent = true })

-- Center search results when jumping to them (n/N)
...
require('telescope').setup {
  ...
  pickers = {
    find_files = {
      find_command = { "fd", "-j2", "-tf", "-HIL", "-c", "never", "--ignore-file", "/home/hxe/.fdignore" }
    }
  }
}
...
vim.keymap.set('n', '<leader><space>', require('telescope.builtin').git_files, { desc = 'Search for [F]iles in [G]it' })
